...
return [
	'url' => env('ALFRESCO_URL','https://alfresco.sonergia.fr/'), //URL of alfresco
	'api' => env('ALFRESCO_API','rest'), //cmis or rest
	...
	//'base_id' => env('ALFRESCO_BASE_ID',null), //Folder where the files will we uploaded, must already exist in the site
