...
use Sonergia\AlfrescoLaravel\Models\AlfrescoObject;
...
class AlfrescoDocument extends AlfrescoObject
{
     ...
     * @return
     */
    public function copyTo($parentId)
     ...
     * @return
     */
    public function copyToPath($parentPath)
    {// throws AlfrescoObjectNotFoundException, AlfrescoObjectAlreadyExistsException{
     ...
     * @return
     */
    public function moveToPath($parentPath)
    {// throws AlfrescoObjectNotFoundException, AlfrescoObjectAlreadyExistsException{
