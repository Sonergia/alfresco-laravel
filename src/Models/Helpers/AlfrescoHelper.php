...
namespace Sonergia\AlfrescoLaravel\Models\Helpers;

use Sonergia\AlfrescoLaravel\Models\Helpers\AlfrescoObjectComparator;
...
class AlfrescoHelper
{
    ...
    public static function getColor($mimetype)
    {
        ...
        if (isset($colors[$mimetype])) {
            return $colors[$mimetype];
        }
    ...
    public static function getShortType($mimetype)
    {
        ...
        if (isset($noms[$mimetype])) {
            return $noms[$mimetype];
        }

        return __("Tipus desconegut");
    }
